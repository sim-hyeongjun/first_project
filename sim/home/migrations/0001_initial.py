# Generated by Django 4.0.7 on 2022-09-28 14:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='home describe')),
                ('image', home.fields.ThumbnailImageField(upload_to='home/%Y%m')),
                ('upload_dt', models.DateField(auto_now_add=True, verbose_name='Upload Date')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='OWNER')),
                ('town', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.town')),
            ],
            options={
                'ordering': ('title',),
            },
